...
def test_remove_paths():
    ...
    graph_5.add_edges_from([(1, 2), (3, 2), (2, 4), (4, 5), (5, 6), (5, 7)])
    ...
    graph_5 = remove_paths(graph_5, [(1,2)], False, False)
    ...
    assert (1, 2) not in graph_5.edges()
...
def test_simplify_bubbles():
    ...
    assert (10, 5) not in graph_1.edges()
    graph_2 = nx.DiGraph()
    graph_2.add_weighted_edges_from([(1, 2, 1), (1, 3, 1), (1, 4, 1), (2, 6, 1), (3, 5, 1), (4, 6, 1), (5, 6, 1)])
    graph_2 = simplify_bubbles(graph_2)
    assert (1, 2) not in graph_2.edges()
    assert (2, 6) not in graph_2.edges()
    assert (1, 4) not in graph_2.edges()
    assert (4, 6) not in graph_2.edges()
